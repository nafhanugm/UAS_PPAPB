...
import com.iqonic.phonphon_store.activity.ProductDetailActivity
import com.iqonic.phonphon_store.models.*
import com.iqonic.phonphon_store.utils.Constants
import com.iqonic.phonphon_store.utils.Constants.AppBroadcasts.CARTITEM_UPDATE
import com.iqonic.phonphon_store.utils.Constants.AppBroadcasts.CART_COUNT_CHANGE
import com.iqonic.phonphon_store.utils.Constants.AppBroadcasts.ORDER_COUNT_CHANGE
import com.iqonic.phonphon_store.utils.Constants.AppBroadcasts.PROFILE_UPDATE
import com.iqonic.phonphon_store.utils.Constants.AppBroadcasts.WISHLIST_UPDATE
import com.iqonic.phonphon_store.utils.Constants.KeyIntent.IS_ADDED_TO_CART
import com.iqonic.phonphon_store.utils.Constants.SharedPref.CART_DATA
import com.iqonic.phonphon_store.utils.Constants.SharedPref.IS_LOGGED_IN
import com.iqonic.phonphon_store.utils.Constants.SharedPref.KEY_CART_COUNT
import com.iqonic.phonphon_store.utils.Constants.SharedPref.KEY_NEXT_TIME_BUY
import com.iqonic.phonphon_store.utils.Constants.SharedPref.KEY_RECENTS
import com.iqonic.phonphon_store.utils.Constants.SharedPref.KEY_USER_ADDRESS
import com.iqonic.phonphon_store.utils.Constants.SharedPref.KEY_USER_CART
import com.iqonic.phonphon_store.utils.Constants.SharedPref.USER_DISPLAY_NAME
import com.iqonic.phonphon_store.utils.Constants.SharedPref.USER_EMAIL
import com.iqonic.phonphon_store.utils.Constants.SharedPref.USER_FIRST_NAME
import com.iqonic.phonphon_store.utils.Constants.SharedPref.USER_ID
import com.iqonic.phonphon_store.utils.Constants.SharedPref.USER_LAST_NAME
import com.iqonic.phonphon_store.utils.Constants.SharedPref.USER_PASSWORD
import com.iqonic.phonphon_store.utils.Constants.SharedPref.USER_PROFILE
import com.iqonic.phonphon_store.utils.SharedPrefUtils
...
fun signIn(id: String?, onResult: (Boolean) -> Unit) {
    getSharedPrefInstance().setValue(IS_LOGGED_IN, true)
    getSharedPrefInstance().setValue(USER_ID, id ?: Random().nextInt(10000).toString())
    onResult(true)
...
//        onApiSuccess(it)
//    })
    ProductRepository.getProductsFromAPI {
        onApiSuccess(it)
    }
}
