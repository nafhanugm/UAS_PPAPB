package com.iqonic.phonphon_store.api.util

import android.util.Log
import com.iqonic.phonphon_store.api.apiModel.entity.Product
import com.iqonic.phonphon_store.api.apiModel.entity.Attribute
import com.iqonic.phonphon_store.api.apiModel.entity.Category
import com.iqonic.phonphon_store.models.ProductModel
import com.iqonic.phonphon_store.models.Attributes
import com.iqonic.phonphon_store.models.Categories
import com.iqonic.phonphon_store.models.Dimensions
import com.iqonic.phonphon_store.models.ImagesData
    ...
    companion object {
        ...
        fun ProductModelToProduct(product: ProductModel): Product {
            return (Product(
                ...
                weight = product.weight,
                dimensions = com.iqonic.phonphon_store.api.apiModel.entity.Dimensions(
                    width = product.dimensions.width,
                    height = product.dimensions.height,
                    length = product.dimensions.length
                ),
                ...
                images = product.images.map {
                    com.iqonic.phonphon_store.api.apiModel.entity.Image(
                        id = it.id.toInt(),
                        src = it.src,
                        name = it.name,
                        dateCreated = null,
